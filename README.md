...
- ENDPOINT - http://127.0.0.1:9501/api/listarClientes - GET

Cadastro de Clientes. 
- Cadastra clientes na plataforma de pagamentos.
- ENDPOINT - http://127.0.0.1:9501/api/criarCliente - POST
...
- ENDPOINT - http://127.0.0.1:9501/api/listarCobrancas - GET

Cadastro de Cobranças.
- Cadastra cobranças na plataforma de pagamentos.
- ENDPOINT - http://127.0.0.1:9501/api/criarCobranca - POST
